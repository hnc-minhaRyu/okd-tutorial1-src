...
import './App.css'; 
 ...
 function App() {
  ...
  let [글제목리스트, 글제목리스트변경] = useState(['첫번째 글', '두번째 글', '세번째 글', '네번째 글', '다섯번째 글', '여섯번째 글', '일곱번째 글']);
  let [날짜, 날짜변경] = useState(['1월 1일 작성', '1월 2일 작성', '1월 3일 작성', '1월 4일 작성', '1월 5일 작성', '1월 6일 작성', '11월 15일 작성']);
